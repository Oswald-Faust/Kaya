  ...
  return (
    <section className="relative mt-28 overflow-hidden text-center sm:mt-36">
      <Reveal className="mx-auto max-w-3xl px-5">
        <h2 className="text-[clamp(42px,5.8vw,80px)] leading-[0.98] font-medium tracking-[-0.045em]">{title}</h2>
        <p className="mt-5 text-lg text-muted">Start free. No credit card. Nothing spends without you.</p>
